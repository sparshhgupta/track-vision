import { HttpMethods, PlainObject, StringOrNumber, RemoveType, Simplify, NarrowPlainObject } from '@gilbarbara/types';
 ...
 */
declare function debounce(callback: (...parameters: any[]) => void, delay: number): (...parameters: any[]) => void;
/**
 ...
 */
declare function on<T extends Window | Document | HTMLElement | EventTarget>(target: T | null, ...rest: Parameters<T['addEventListener']> | [string, Function | null, ...any]): void;
/**
 * Remove the event listener from the target
 */
declare function off<T extends Window | Document | HTMLElement | EventTarget>(target: T | null, ...rest: Parameters<T['removeEventListener']> | [string, Function | null, ...any]): void;
 ...
 */
declare function percentage(input: number, total: number, digits?: number): number;
/**
 ...
 */
declare function cleanUpObject<T extends PlainObject>(input: T): RemoveType<T>;
/**
 ...
 */
declare function mergeProps<TDefaultProps extends PlainObject<any>, TProps extends PlainObject<any>>(defaultProps: TDefaultProps, props: TProps): Simplify<TProps & Required<Pick<TProps, keyof TDefaultProps & string>>>;
/**
 * Type-safe Object.entries()
 */
declare function objectEntries<T extends PlainObject<any>>(input: T): Array<{ [K in keyof T]-?: [K, T[K]]; }[keyof T]>;
/**
 * Type-safe Object.keys()
 */
declare function objectKeys<T extends PlainObject<any>>(input: T): Array<keyof T>;
/**
